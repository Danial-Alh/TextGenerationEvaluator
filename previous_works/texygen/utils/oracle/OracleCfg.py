...
class OracleCfg:
    def __init__(self, cfg_grammar=None, origin_file='save/origin.txt', oracle_file='save/oracle.txt',
                 ...
                 sequence_length=None, generate_from_scratch=False):
        ...
        import os, inspect
        self.saving_path = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe()))) + '/save/'
        return

    def generate_sentence(self, depth=9, num=30000):
        if not self.generate_from_scratch:
            import os
    ...
    def pre_process(self):
        ...
        [word_index_dict, index_word_dict] = load_or_create_dictionary(tokens, self.saving_path,
                                                                       'oracle-cfg-dictionaries')
